...
Esse é um site de pizzaria feito com React. O principal objetivo foi aprender a usar o React Router DOM pra navegar entre as páginas de forma simples e rápida, sem recarregar a página toda.
O site tem as seguintes seções: Home, Cardápio e Contato.
...
![Mobile3](Thumbnail-Pizzaria.png)
...
1. Clone o repositório:
   ```bash
  	https://github.com/Joao-vitorSantos08/Pizzaria-React.git
...
- **React Router DOM** – Biblioteca para gerenciar a navegação entre páginas  
